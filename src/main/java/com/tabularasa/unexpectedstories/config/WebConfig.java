...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:3000", "http://10.150.151.211:3000", "http://10.150.151.211:3000/board/count", "https://unexpected-stories-front.vercel.app/") // 허용할 도메인들 설정
